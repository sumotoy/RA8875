/*
fillWindow will fill the active window (set by setActiveWindow) with a choosed color. When startup library the
active window it's the whole screen so it acts as clearSceen.
